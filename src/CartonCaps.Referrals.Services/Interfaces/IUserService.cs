...
public interface IUserService
{
    ...
    /// <returns>A <see cref="ResultOf{User}"/> containing the user if found; otherwise, a result indicating failure.</returns>
    ResultOf<User> GetUser(long id);
    ...
    /// <returns>A <see cref="ResultOf{List{User}}"/> containing the users if found; otherwise, a result indicating failure.</returns>
    ResultOf<List<User>> GetUsersByIds(long[] userIds);
    ...
    /// <returns>A <see cref="ResultOf{string}"/> containing the referral link if found; otherwise, a result indicating failure.</returns>
    ResultOf<string> GetUserReferralLink(long userId);
}
